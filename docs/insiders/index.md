...
*MkDocs Manpage* follows the **sponsorware** release strategy, which means
...
*MkDocs Manpage Insiders* is a private fork of *MkDocs Manpage*, hosted as
...
repository.
  ...
  [^1]:
    ...
    existing features that must be supported by *MkDocs Manpage*.
...
*MkDocs Manpage* and released for general availability, making them available
...
The biggest bottleneck in Open Source is time.[^3]
  ...
  [^3]:
    ...
    The sponsorware model ensures that if you decide to use *MkDocs Manpage*,
...
<small>
  ...
  your profile and avatar to show your support for *MkDocs Manpage*.
...
to use *MkDocs Manpage* locally without having access to Insiders.
Is this still possible?

Yes. Insiders is compatible with *MkDocs Manpage*. Almost all new features
...
Yes. Whether you're an individual or a company, you may use *MkDocs Manpage
Insiders* precisely under the same terms as *MkDocs Manpage*, which are given
